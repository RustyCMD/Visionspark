...
// in visionspark/test/auth/auth_gate_test.dart.
...
class MockAuthState extends _i1.Mock implements _i2.AuthState {
  ...
  @override
  bool get fromBroadcast =>
      (super.noSuchMethod(Invocation.getter(#fromBroadcast), returnValue: false)
          as bool);
}
